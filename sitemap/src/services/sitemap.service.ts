...
import { Sitemap, SitemapInfo, SitemapItem, SitemapResponse } from '../interfaces/sitemap.interface';
import { Buffer } from 'buffer';
import { xml2json, json2xml } from 'xml-js';
import { SitemapFireStoreService, defaultSitemapXmlStr } from '@annuadvent/ngx-tools/fire-sitemap-storage';
